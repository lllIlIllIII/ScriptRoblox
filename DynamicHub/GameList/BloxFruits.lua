...
spawn(function()
    ...
    M:Toggle("Teleport To Gear",false,function(value)
...
task.spawn(function()
	while task.wait() do
		pcall(function()
			if Radioactive or _G.Makori_gay or _G.Umm or _G.Auto_Wing or _G.Leather or Scrap or Cocoafarm or Dragon_Scale or MiniHee or MakoriGayMag and _G.BringMonster then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
RaceV4:Label("Go to Third Sea Pls🥺")
end
...
Esp:Toggle("ESP Island",IslandESP,function(value)
    ...
    Esp:Toggle("Esp Npc", false, function(nec)
    NpcESP = nec
end)
spawn(function()
    while wait() do
