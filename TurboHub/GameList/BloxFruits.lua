...
local Library = Update:Window("Turbo Hub","",Enum.KeyCode.RightControl);
    ...
    local AutoMisc = Library:Tab("Setting","rbxassetid://11446835336")
    local Swords = Library:Tab("Wepons","rbxassetid://11446859498")
...
Main:Button("Copy Discord Link",function()
 setclipboard("https://discord.gg/RSzDPwzC")
 end)
...
wait(1)
Notification:Notify(
   {Title = "TURBO HUB", Description = "You Have Max Observation"},
...
game.StarterGui:SetCore("SendNotification", {
        Title = "TURBO HUB"; -- the title (ofc)
        Text = "Mirage not Found!"; -- what the text says (ofc)
        Icon = "rbxassetid://12362129605"; -- the image if u want. 
...
local url = "https://discord.com/api/webhooks/1050996834413334549/0-iPYRJpF87gn27kW9vqV3a633zI4c432K0OVrfqEX8KghhQxVdL5DiuMMjxF-XgOVWi" -- ur webhook url
local data = {
	["username"] = 'TURBO HUB', -- Webhook name here
	...
	["embeds"] = {
		{
			...
			["footer"] = {
				["text"] = "Webhook By", -- you can remove this but it will hurt
			},
...
AutoMisc:Toggle("Super Fast Attack [Coming Soon]",false,function(value)
...
spawn(function()
 ...
 AutoMisc:Toggle("Smooth Mode",false,function(value)
...
AutoMisc:Label("[ Smooth Mode ]")
AutoMisc:Label("• Remove Attack")
AutoMisc:Label("• Remove Sound")
AutoMisc:Label("• Disabled Damage")
AutoMisc:Label("• Remove Death Effect")
...
request(abcdef)
    ...
    AutoMisc:Toggle("Send",true,function(value)
        _G.SendWeb = value
    end)
