...
if game.PlaceId == 6284583030 or game.PlaceId == 10321372166 or game.PlaceId == 7722306047 or game.PlaceId == 12610002282 then
	...
	main:Toggle('Auto Farm',AutoFarm_Enabled,function(Value) 
		enableAutoFarm = Value
	end)
	main:Toggle('Fast Mode',AutoFarm_FastMode,function(Value) 
	...
	-- autoFarmTab:CreateSlider({
		...
		main:Slider("Farm Speed",0.05,2,0.3,function(v)
			AutoFarm_FarmSpeed = v
		end)
		local farmMaxDistance = 150
		main:Slider("Farm Distance",10,tonumber(Library.Settings.CoinGrabDistance) or 300,150,function(v)
			farmMaxDistance = v
		end)
		-- autoFarmTab:CreateSlider({
